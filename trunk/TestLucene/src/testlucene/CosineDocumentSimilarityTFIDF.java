...
public class CosineDocumentSimilarityTFIDF {
    ...
    public static void main(String[] args) {
        try {
            CosineDocumentSimilarityTFIDF cosSim = new 
                    CosineDocumentSimilarityTFIDF( "This is good", 
                            "This is good" );
    ...
    CosineDocumentSimilarityTFIDF(String s1, String s2) throws IOException {
